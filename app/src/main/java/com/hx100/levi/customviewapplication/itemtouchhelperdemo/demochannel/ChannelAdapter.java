package com.hx100.levi.customviewapplication.itemtouchhelperdemo.demochannel;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_MY_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.item_itemtouchhelper_my_channel_header, parent, false);
            ...
            case TYPE_MY:
                view = mInflater.inflate(R.layout.item_itemtouchhelper_my, parent, false);
            ...
            case TYPE_OTHER_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.item_itemtouchhelper_other_channel_header, parent, false);
                return new RecyclerView.ViewHolder(view){};

            case TYPE_OTHER:
                view = mInflater.inflate(R.layout.item_itemtouchhelper_other, parent, false);
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        //当前我的频道的item移动到其他频道的第一个item
        //这里只有item依次排序的动画 没有实现从我的频道的item “飞”到其他频道第一个item的动画
