package com.hx100.levi.customviewapplication.customview.ScrollNumberView;
...
public class MultiScrollNumberView extends LinearLayout {
    ...
    private int[] mTextColors = new int[]{Color.WHITE};
