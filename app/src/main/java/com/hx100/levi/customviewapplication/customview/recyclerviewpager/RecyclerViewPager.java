...
import com.hx100.levi.customviewapplication.BuildConfig;
...
public class RecyclerViewPager extends RecyclerView {
    ...
    protected void adjustPositionX(int velocityX) {
        ...
        if (childCount > 0) {
            ...
            if (mSinglePageFling) {
                ...
                if (DEBUG) {
                    Log.i("@", "flingCount:" + flingCount);
                    Log.i("@", "original targetPosition:" + targetPosition);
                }
            }
            ...
            if (DEBUG) {
                Log.i("@", "mTouchSpan:" + mTouchSpan);
                Log.i("@", "adjustPositionX:" + targetPosition);
            }
    ...
    protected void adjustPositionY(int velocityY) {
        ...
        if (childCount > 0) {
            ...
            if (DEBUG) {
                Log.i("@", "mTouchSpan:" + mTouchSpan);
                Log.i("@", "adjustPositionY:" + targetPosition);
            }
            smoothScrollToPosition(safeTargetPosition(targetPosition, getItemCount()));
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if (ev.getAction() == MotionEvent.ACTION_DOWN && getLayoutManager() != null) {
            ...
            if (DEBUG) {
                Log.i("@", "mPositionOnTouchDown:" + mPositionOnTouchDown);
            }
        }
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == SCROLL_STATE_DRAGGING) {
            ...
            if (mCurView != null) {
                ...
                if (DEBUG) {
                    Log.i("@", "mPositionBeforeScroll:" + mPositionBeforeScroll);
                }
            ...
            if (mNeedAdjust) {
                ...
                if (DEBUG) {
                    Log.i("@", "onPageChanged:" + mSmoothScrollTargetPosition);
                }
                if (mOnPageChangedListeners != null) {
                    for (OnPageChangedListener onPageChangedListener : mOnPageChangedListeners) {
                        if (onPageChangedListener != null) {
